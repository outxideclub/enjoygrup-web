...
// Los helpers de eventos (formateo, URLs, géneros/artistas) viven ahora en
// @/lib/events y se comparten con la agenda unificada.
...
export function OutxideClient({ initialEvents }: { initialEvents: FVEvent[] }) {
  ...
  // Los eventos llegan pre-renderizados desde el servidor (SSR) vía initialEvents.
          ...
          >
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                ...
                size="lg"
                variant="outxide"
                className="btn-magnetic rounded-full px-8 shadow-lg shadow-outxide/20"
              >
                <a href="#eventos">
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              { slug: "fiestas-eventos-verano-alcudia-2026", label: locale === "es" ? "Fiestas y Eventos de Verano 2026" : locale === "de" ? "Sommerfeste & Events 2026" : locale === "fr" ? "Fêtes et Événements d'Été 2026" : locale === "it" ? "Feste ed Eventi Estivi 2026" : "Summer Festivals & Events 2026" },
              { slug: "vida-nocturna-mallorca-guia", label: locale === "es" ? "Guía de Vida Nocturna en Mallorca" : locale === "de" ? "Nachtleben-Guide Mallorca" : locale === "fr" ? "Guide Vie Nocturne à Majorque" : locale === "it" ? "Guida Vita Notturna a Maiorca" : "Mallorca Nightlife Guide" },
            ].map((article) => (
              <Link
                key={article.slug}
