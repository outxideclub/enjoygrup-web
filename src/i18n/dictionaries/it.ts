...
export const it: Dictionary = {
  ...
  mundial: {
    ...
    subtitle: "Vivi le partite sui maxi schermi di Outxide, dalla terrazza di Enjoy.",
    intro: "Trasmettiamo in diretta tutte le partite che si giocano tra le 17:00 e le 23:00 sugli schermi di Outxide. Atmosfera terrazza all'Enjoy, senza ingresso discoteca.",
    watchAtOutxide: "In diretta a Outxide",
    matchOfTheNight: "Partita della serata",
    conflictNote: "In contemporanea con un'altra — non trasmessa",
    filterAll: "Tutte",
    filterOutxide: "Solo a Outxide",
    group: "Girone",
    ...
    nextAtOutxide: "Prossima a Outxide",
    upcoming: "Prossime a Outxide",
    ...
    homeBannerTitle: "Mondiali 2026, in diretta a Outxide",
    ...
    metaDescription: "Vivi i Mondiali 2026 sui maxi schermi di Outxide, dalla terrazza di Enjoy a Port d'Alcúdia. Calendario completo e le partite che trasmettiamo in diretta dalle 17 alle 23.",
