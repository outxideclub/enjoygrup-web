export const es = {
  ...
  mundial: {
    ...
    subtitle: "Vive los partidos en las pantallas gigantes de Outxide, desde la terraza de Enjoy.",
    intro: "Retransmitimos en directo los partidos que caen entre las 17:00 y las 23:00 en las pantallas de Outxide. Ambiente de terraza en Enjoy, sin entrada de discoteca.",
    watchAtOutxide: "Se ve en Outxide",
    matchOfTheNight: "Partido de la noche",
    conflictNote: "Coincide con otro — no se emite",
    filterAll: "Todos",
    filterOutxide: "Solo en Outxide",
    group: "Grupo",
    ...
    nextAtOutxide: "Próximo en Outxide",
    upcoming: "Próximos en Outxide",
    ...
    homeBannerTitle: "Mundial 2026, en directo en Outxide",
    ...
    metaDescription: "Vive el Mundial 2026 en las pantallas gigantes de Outxide, desde la terraza de Enjoy en Port d'Alcúdia. Calendario completo y los partidos que retransmitimos en directo de 17:00 a 23:00.",
